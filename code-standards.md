...
- **Hashing:** Passwords must *always* be hashed using `bcrypt` before storing.
...
- **Augmented Prompting:** Inject the Top-K chunks into the prompt context. Instruct the LLM strictly to "answer based *only* on the provided context."
